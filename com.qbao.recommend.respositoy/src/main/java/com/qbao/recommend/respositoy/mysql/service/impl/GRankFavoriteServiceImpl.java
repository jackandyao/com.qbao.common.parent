...
import com.qbao.recommend.respositoy.mysql.service.IGRankFavoriteService;
 ...
 */
@Service("gRankFavoriteServiceImpl")
public class GRankFavoriteServiceImpl implements IGRankFavoriteService { @Value("${recommend.datasource.key}")
private String datasourceKey;

    @Value("${GRANK_FAVORITE}")
